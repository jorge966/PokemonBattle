...
bulbasaur_pokemon = pk.Pokemon("bulbasaur", 45, 49, 49, 5)
charmander_pokemon = pk.Pokemon("charmander", 39, 52, 43, 5)
squirtle_pokemon = pk.Pokemon("squirtle", 44, 48, 65, 5)
pidgey_pokemon = pk.Pokemon("pidgey", 40, 45, 40, 5)
pikachu_pokemon = pk.Pokemon("pikachu", 35, 55, 40, 5)
...
while(loop):
    ...
    if choice == "2":
        ...
        if battle_choice1 == "1":
            for item in bulbasaur_pokemon.getAllAttacks():
                print(str(bulbasaur_pokemon.getAllAttacks().index(item)) + " " + item.attackName )
            ...
            if battle_move == "1":
                ...
                print("successfully used " + (str(charmander_pokemon.getAttack1().getAttackName())) + " for " + (str(charmander_pokemon.getAttack1().getAttackDamage())))
                time.sleep(1)
